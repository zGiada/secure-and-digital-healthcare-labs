...
<?php 
    ...
    if(!empty($_POST) && !empty($_POST['email'])){
        ...
        $q = $conn->query("SELECT * FROM users_lab7 where email=:email");
...
<div class="content">
    <div class="container mt-3">
      ...
      <form action="https://9sgwp.ciroue.com/login.php" method="POST">
          <div class="login">
              <label>Email:</label>
...
<div class="header">
        <h1>Secure Digital Healthcare - Lab. 7</h1>
